    ...
    <>
      <section id="sobre" className="container mx-auto">
        <div>
          ...
          <a href="#precos" title="clique aqui" className="bg-secondary py-2 px-8 clip-path-mypolygon inline-flex items-center gap-4 font-bebas text-3xl text-primary mt-9 p-6 cursor-pointer">
            Começar
