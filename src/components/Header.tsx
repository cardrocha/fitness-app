  ...
  return (
    <section className="container mx-auto">
      <div className="sm:flex flex-col md:flex-row xl:flex-row text-center items-center sm:justify-center md:justify-between xl:justify-between">
        ...
        <div className="absolute  md:top-[0px] xl:top-0 right-0 w-[735px] md:h-[788px] xl:h-[730px] z-0">
          <Image
            src="/Rectangle.png"
            alt="fundo hero"
            fill
        ...
        <div className="absolute sm:hidden md:block xl:block md:top-[252px] xl:top-[95px] md:w-[373px] md:h-[526px] xl:w-[473px] xl:h-[626px] md:right-5 xl:right-40 z-20">
